            ...
            <Layout className="pt-16">
                ...
                <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
                    ...
                    <Project 
                        ...
                        title="GAA Online CoachBoard"
                        img={GAABoard}
                        summary="An online GAA tactics board."
                        link="https://mikelynagh.github.io/GAACoachBoard/"
                        github="https://github.com/MikeLynagh/GAACoachBoard"
                        type="ReactJS,"
                        />
                    </div>
